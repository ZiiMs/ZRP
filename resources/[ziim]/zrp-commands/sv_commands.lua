...
RegisterCommand('tetu', function(source, args)
  -- TODO: make a vehicle! fun!
  Database:findOneAndUpdate({ collection="Players", query = { username = username }, update = { ["$set"] = { first_name = "Fierll" }}, options = { returnNewDocument = true }}, function (success, result)
    if not success then
