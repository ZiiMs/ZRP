...
Citizen.CreateThread(function()
    while true do
      ...
      if #toDelete > 0 then
        TriggerServerEvent('__zrp:peds:rogue', toDelete)
      else
        MarkedPeds = {}
      end
...
RegisterNetEvent('__zrp:peds:delete')
AddEventHandler('__zrp:peds:delete', function(pNetId)
  local tNetId = 0 
...
RegisterNetEvent('__zrp:peds:decor:set')
AddEventHandler('__zrp:peds:decor:set', function (pNetId, pType, pProperty, pValue)
